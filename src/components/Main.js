    ...
    return (
        ...
        { /*<div className='background'>
            ...
            <div className='mainFeatureImg'>
                <img src='https://github.com/gzm17/sejourmint-gp1/blob/main/public/assets/images/mainFeature/mf-win-back.jpg' className='featureImgFrame' alt='Hotel Sejour Mint Winter 1' />
            </div>
            ...
            <div className='mainFeatureGroup1'>
                <img src='../../public/assets/images/mainFeature/mf-welcome1.jpg' className='mainFeatureGroup1Image1' alt='Hotel Sejour Mint Winter 2' />
                <div className='mainFeatureGroup1Text'> {welcome}
                    {/* <SectionText text={mainFeatureText} language={props.language}/> */}
                </div>
                <img src='../../public/assets/images/mainFeature/mf-welcome2.jpg' className='mainFeatureGroup1Image2' alt='Hotel Sejour Mint Winter 2' />
                <img src='../../public/assets/images/mainFeature/mf-welcome3.jpg' className='mainFeatureGroup1Image3' alt='Hotel Sejour Mint Winter 2' />
            </div>
            <div className='sectionEnd'>{}</div>
            ...
            <div className='mainFeatureGroup2'>
                ...
                <img src='../../public/assets/images/features/f1-goryu-night.jpg' className='mainFeatureGroup2Image1' alt='Hotel Sejour Mint Winter 2' />
                <img src='../../public/assets/images/features/f3-choukokuji.jpg' className='mainFeatureGroup2Image3' alt='Hotel Sejour Mint Winter 2' />
                <img src='../../public/assets/images/features/f2-ski-ita.jpg' className='mainFeatureGroup2Image2' alt='Hotel Sejour Mint Winter 2' />
            </div>
            <div className='sectionEnd'>{}</div>
            ...
            <div className='foodGroup'>
                <img src='../../public/assets/images/foods/foods-dinner.jpg' className='foodGroupImage1' alt='Foods Dinner' />
                <img src='../../public/assets/images/foods/foods-diningRm.jpg' className='foodGroupImage2' alt='Foods Dinning Room' />
                <img src='../../public/assets/images/foods/foods-beer.jpg' className='foodGroupImage3' alt='Foods Beer' />
            ...
            <div className='activitiesMasterGroup'>
                <div className='activitiesImageGroup'>
                    <img src='../../public/assets/images/activities/activities-1.jpg' className='activitiesImage1' alt='Act 1' />
                    <img src='../../public/assets/images/activities/activities-2.jpg' className='activitiesImage2' alt='Act 2' />
                    <img src='../../public/assets/images/activities/activities-3.jpg' className='activitiesImage3' alt='Act 3' />
                    <img src='../../public/assets/images/activities/activities-4.jpg' className='activitiesImage4' alt='Act 4' />
                </div>
